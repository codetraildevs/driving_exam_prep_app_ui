    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          // Scroll view already applies 24px padding; only cap width so
          // instructions stay readable on desktop.
          child: ConstrainedContent(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(l10n.examInstructions, style: AppTextStyles.heading3),

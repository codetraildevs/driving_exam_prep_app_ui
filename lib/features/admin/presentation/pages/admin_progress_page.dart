...
class _AdminProgressPageState extends State<AdminProgressPage> {
  ...
  Future<void> _loadResults() async {
    ...
    try {
      ...
      setState(
        () =>
            _error = AppLocalizations.of(context).errorUnexpected(e.toString()),
      );
    } finally {
            ...
            child: _isLoading
                ...
                : RefreshIndicator(
                    ...
                    child: SingleChildScrollView(
                      ...
                      // Scroll view already applies 16px side padding; only cap
                      // width so stat cards and rows stay readable on desktop.
                            ...
                            ..._topPerformers.asMap().entries.map((entry) {
                              ...
                              final name =
                                  (r['userName'] ??
                                      ...
                                      .toString();
                              final score =
                                  (r['score'] ?? r['percentage'] ?? 0) as num;
                              final examTitle =
                                  (r['examTitle'] ?? r['exam_title'] ?? '')
                                      .toString();
                              final date =
